import{i as m,N as v}from"./index-gBHwmMKl.js";/**
 * @license @lucide/vue v1.44.0 - ISC
 *
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const F=e=>e==null?void 0:e.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase();/**
 * @license @lucide/vue v1.44.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const H=Symbol("lucide-icons");function O(){return m(H,{})}/**
 * @license @lucide/vue v1.44.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const U=({name:e,iconNode:t,"icon-node":s,icon:o={name:F(e),node:t??s,size:24,aliases:[]},absoluteStrokeWidth:r,"absolute-stroke-width":u,nonScalingStroke:h,"non-scaling-stroke":f,strokeWidth:w,"stroke-width":k,size:d,width:A=d,height:g=d,color:a,...i},{slots:n})=>{var C;const{size:c,color:b,strokeWidth:S=2,absoluteStrokeWidth:y=!1,nonScalingStroke:B=!1,class:$=""}=O(),I=x(r)||x(u)||r===!0||u===!0||y===!0,L=x(h)||x(f)||h===!0||f===!0||B===!0;delete i.class;const N=(C=n.default)==null?void 0:C.call(n),[,j,P=[]]=T(o,{color:a??b,width:A??d??c,height:g??d??c,strokeWidth:w??k??S,absoluteStrokeWidth:I,nonScalingStroke:L,className:$,hasA11yProp:N!=null&&N.length>0||D(i),attributes:i});return v("svg",j,[...P.map(E=>v(...E)),...N??[]])};/**
 * @license @lucide/vue v1.44.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
